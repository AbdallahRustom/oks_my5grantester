...
func init() {
    ...
    // log.Infof("GNodeB Control IP: %s", cfg.GNodeB.ControlIF.Ip)
    // log.Infof("GNodeB Control Port: %d", cfg.GNodeB.ControlIF.Port)
    // log.Infof("GNodeB Data IP: %s", cfg.GNodeB.DataIF.Ip)
    // log.Infof("GNodeB Data Port: %d", cfg.GNodeB.DataIF.Port)
	// log.Infof("GNodeB MCC Port: %s", cfg.GNodeB.PlmnList.Mcc)
	// log.Infof("GNodeB MNC Port: %d", cfg.GNodeB.PlmnList.Mnc)
	// log.Infof("GNodeB TAC Port: %s", cfg.GNodeB.PlmnList.Tac)
	// log.Infof("GNodeB GNBID Port: %d", cfg.GNodeB.PlmnList.GnbId)
	// log.Infof("GNodeB GNBID Sst Port: %s", cfg.GNodeB.SliceSupportList.Sst)
	// log.Infof("GNodeB GNBID Sd Port: %d", cfg.GNodeB.SliceSupportList.Sd)
	// log.Infof("GNodeB UEMSIN  Port: %s", cfg.Ue.Msin)
	// log.Infof("UE Key : %d", cfg.Ue.Key)
	// log.Infof("UE opc : %s", cfg.Ue.Opc)
	// log.Infof("UE AMF : %d", cfg.Ue.Amf)
	// log.Infof("UE sqn : %s", cfg.Ue.Sqn)
	// log.Infof("UE Dnn : %d", cfg.Ue.Dnn)
	// log.Infof("UE MCC : %s", cfg.Ue.Hplmn.Mcc)
	// log.Infof("UE MNC : %d", cfg.Ue.Hplmn.Mnc)
	// log.Infof("UE SST : %s", cfg.Ue.Snssai.Sst)
	// log.Infof("UE SD : %d", cfg.Ue.Snssai.Sd)
	// log.Infof("AMF IP: %s", cfg.AMF.Ip)
    // log.Infof("AMF Port: %d", cfg.AMF.Port)
